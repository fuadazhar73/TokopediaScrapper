...
import org.fuad.webdriver.DefaultWebDriver;
import org.openqa.selenium.By;
import org.openqa.selenium.WebElement;

public class TokopediaScrapper {
    /* here URL Tokopedia for scrapping data */
    ...
    private static final String OTHER_PATH = "/search?sc=18";
    ...
    public enum Category {
        HANDPHONE(24), LAPTOP(3844),OTHER(18);
    ...
    /* here for processing the data what we want */
